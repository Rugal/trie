 ...
 *
 * @author Brian Harris (brian_bcharris_net), Rugal Bernstein
 */
public class TrieImpl implements Trie
{
    ...
    public String bestMatch(String word, long max_time)
    {
        ...
        PriorityQueue<DYMNode> pq = new PriorityQueue<>();
...
class TrieNode
{
    ...
    {
        sb.append(prefix).append(c).append("(").append(occurances).append(")" + "\n");
